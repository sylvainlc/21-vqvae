...
The results are displayed in the form of a heatmap, for the red channel, in Figure~\ref{fig:compare_distro_kl_pixelcnn}.
...
Results are presented in Figure~\ref{fig:compare_distro_hist_pixelcnn}.
	\item Sanity check:
		\begin{itemize}
