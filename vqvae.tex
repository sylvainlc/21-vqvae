...
$$
p^z_{\theta,T}(\latentdis^T,\ldots,\latentdis^0) %&= p_{\theta,T}(Z_q^T,Z_e^T) \left\{\prod_{t=0}^{T-1}p_{\theta,t}(Z_q^t,Z_e^t|Z_q^{t+1},Z_e^{t+1})\right\}  p_{\theta,0}(X|Z^{0:T}_q,Z_e^{0:T})\,,\\
