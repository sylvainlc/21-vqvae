...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.45]{centroids2.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.4]{noisedenoise2.png}
...
\begin{subfigure}{\linewidth}
    \centering
    \includegraphics[width=.8\linewidth]{samples2.png}
    \caption{Samples from our diffusion prior.}
    \label{fig:diffusion_samples}
\end{subfigure}
\begin{subfigure}{\linewidth}
    \centering
    \includegraphics[width=.8\linewidth]{pixel_samples.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.8\linewidth]{cond_samples_center_2.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.8\linewidth]{cond_samples_topleft.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.8\linewidth]{chains2.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.8\linewidth]{chains_unconditional.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.4]{samplesFixed.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.8\linewidth]{samples.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.8\linewidth]{cond_sampling2.png}
