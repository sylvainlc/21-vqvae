...
\begin{subfigure}{\linewidth}
    \centering
    \includegraphics[width=.8\linewidth]{images/ours/samples2.png}
    \caption{Samples from our diffusion prior.}
    \label{fig:diffusion_samples}
\end{subfigure}
\begin{subfigure}{\linewidth}
    \centering
    \includegraphics[width=.8\linewidth]{images/ours/pixel_samples.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.8\linewidth]{images/ours/cond_samples_center_2.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.8\linewidth]{images/ours/cond_samples_topleft.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.8\linewidth]{images/ours/chains2.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.8\linewidth]{images/ours/chains_unconditional.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.8\linewidth]{images/ours/samples.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.8\linewidth]{images/ours/cond_sampling2.png}
